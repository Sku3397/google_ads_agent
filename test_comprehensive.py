...
class TestGoogleAdsAgentComprehensive(unittest.TestCase):
    ...
    def _create_mock_ads_api(self):
        ...
        class MockGoogleAdsAPI:
            ...
            def apply_optimization(self, optimization_type, entity_type, entity_id, changes):
                ...
                return True, f"Successfully applied {optimization_type} to {entity_type} {entity_id}"
    ...
    def test_date_range_conversion(self):
        ...
        for days in [1, 7, 30, 90, 365]:
            ...
            match = re.search(r"BETWEEN '(\d{4}-\d{2}-\d{2})' AND '(\d{4}-\d{2}-\d{2})'", date_clause)
            ...
            self.assertEqual(actual_days, expected_days, f"Expected date range of {expected_days} days, got {actual_days}")
    ...
    def test_keyword_data_fetching(self):
        ...
        campaign_id = '123456789'
        filtered_keywords = self.ads_api.get_keyword_performance(days_ago=30, campaign_id=campaign_id)
    ...
    def test_suggestion_parsing_and_application(self):
        ...
        for suggestion in suggestions:
            ...
            if suggestion['action_type'] == 'BID_ADJUSTMENT' and suggestion['entity_type'] == 'keyword':
            ...
            elif suggestion['action_type'] == 'STATUS_CHANGE' and suggestion['entity_type'] == 'keyword':
                success, message = self.ads_api.apply_optimization(
                    'status_change',
                    'keyword',
                    suggestion['entity_id'],
            ...
            elif suggestion['action_type'] == 'BUDGET_ADJUSTMENT' and suggestion['entity_type'] == 'campaign':
                success, message = self.ads_api.apply_optimization(
                    'budget_adjustment',
                    'campaign',
                    suggestion['entity_id'],
    ...
    def test_all_functionality(self):
        ...
        for suggestion in suggestions:
            if suggestion['status'] == 'pending':
                if suggestion['action_type'] == 'BID_ADJUSTMENT' and suggestion['entity_type'] == 'keyword' and applied_count == 0:
                    success, message = self.ads_api.apply_optimization(
                        'bid_adjustment',
                        'keyword',
                        suggestion['entity_id'],
                ...
                elif suggestion['action_type'] == 'STATUS_CHANGE' and suggestion['entity_type'] == 'keyword' and applied_count == 1:
                    success, message = self.ads_api.apply_optimization(
                        'status_change',
                        'keyword',
                        suggestion['entity_id'],
                ...
                elif suggestion['action_type'] == 'BUDGET_ADJUSTMENT' and suggestion['entity_type'] == 'campaign' and applied_count == 2:
                    success, message = self.ads_api.apply_optimization(
                        'budget_adjustment',
                        'campaign',
                        suggestion['entity_id'],
