...
class SERPScraperService(BaseService):
        ...
        try:
            ...
            for ad_element in ad_elements:
                try:
                    ...
                    try:
                        extension_elements = ad_element.find_elements(
                            By.CSS_SELECTOR, "div.MUxGbd.lyLwlc"
                        )
    ...
    def _extract_knowledge_panel(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            panel_data = {"title": title, "attributes": {}}
            ...
            for element in local_elements:
                try:
                    result = {
                        ...
                        "type": element.find_element(
                            By.CSS_SELECTOR, "div.rllt__details div:nth-child(2)"
                        ).text,
                        "address": element.find_element(
                            By.CSS_SELECTOR, "div.rllt__details div:nth-child(3)"
                        ).text,
                    }
    ...
    def _extract_shopping_results(self) -> Optional[List[Dict[str, Any]]]:
        ...
        try:
            shopping_container = self.driver.find_element(
                By.CSS_SELECTOR, "div.commercial-unit-desktop-top"
            )
            shopping_results = []
            ...
            for element in product_elements:
                try:
                    result = {
                        ...
                        "vendor": element.find_element(
                            By.CSS_SELECTOR, "div.pla-extensions-container"
                        ).text,
                    }
    ...
    def analyze_competitor_ads(self, queries: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            sorted_competitors = sorted(
                competitor_stats.items(), key=lambda x: x[1]["ad_count"], reverse=True
            )
    ...
    def track_keyword_rankings(
        self, keywords: List[str], domain: str, store_history: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    def _store_historical_rankings(self, domain: str, ranking_data: Dict[str, Any]) -> None:
        ...
        history_file = os.path.join(
            self.results_dir, f"ranking_history_{domain.replace('.', '_')}.json"
        )
