...
def parse_arguments():
    ...
    parser.add_argument(
        "--mode",
        choices=["immediate", "schedule", "service"],
        default="immediate",
    ...
    parser.add_argument(
        ...
        default="monday",
        help="Day of the week for weekly schedule",
    )
    ...
    # Analysis options
    parser.add_argument(
        "--days", type=int, default=30, help="Number of days of data to analyze (1-90)"
    )
    ...
    try:
        ...
        if args.mode == "immediate":
            ...
            if args.frequency == "daily":
                ...
                logger.info(
                    f"Scheduling weekly analysis on {args.day} at {args.hour:02d}:{args.minute:02d}"
                )
                agent.schedule_weekly_analysis(
                    day_of_week=args.day, hour=args.hour, minute=args.minute
                )
