...
class AdsAgentLogger:
    ...
    def __new__(cls, *args, **kwargs):
        if not cls._instance:
            with cls._lock:
                if not cls._instance:
                    cls._instance = super(AdsAgentLogger, cls).__new__(cls)
        return cls._instance

    def __init__(self, log_dir="logs"):
        # Only initialize once
        if AdsAgentLogger._initialized:
            return
        ...
        with self._lock:
            ...
            # Mark as initialized
            AdsAgentLogger._initialized = True
    ...
    def _add_recent_log(self, level, message):
        ...
        while len(self.recent_logs) > self.max_recent_logs:
